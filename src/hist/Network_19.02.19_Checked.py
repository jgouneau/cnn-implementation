...
class Network:
    ...
    def train(self, example):
        ...
        out = np.copy(self.layers[n-1].output)
...
def Test_Deep_Conv():
    lay_list = [(Input, (3, 32, 32)),
                (ConvMax, (5, 5, 1, -1, (0.5, 0.4, 0.0005))),
                (Pooling, (2, 2)),
                (ConvMax, (5, 5, 1, -1, (0.5, 0.4, 0.0005))),
                (Pooling, (2, 2)),
                (ConvMax, (5, 5, 1, -1, (0.5, 0.4, 0.0005))),
                (FullyMax, (4, 1, 1, (0.1, 0.7, 0.0005)))]
    cat_list = [0, 1, 2]
...
def The_Grand_Test():
	lay_list = [(Input, (3, 32, 32)),
                (ConvMax, (12, 5, 1, -1, (0.1, 0.7, 0.0005))),
                (Pooling, (2, 2)),
                (ConvMax, (12, 5, 1, -1, (0.1, 0.7, 0.0005))),
                (Pooling, (2, 2)),
                (ConvMax, (10, 5, 1, -1, (0.1, 0.7, 0.0005))),
                (Pooling, (2, 2)),
                (FullyMax, (1, 1, 10, (0.1, 0.7, 0.0005)))]
